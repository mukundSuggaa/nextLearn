import { db, VercelPoolClient, sql } from '@vercel/postgres';
import {
  CustomerField,
  CustomersTableType,
  InvoiceForm,
...
export async function fetchRevenue() {
  ...
  try {
    // const data = await client.query<Revenue>(`SELECT * FROM revenues`);
...
export async function fetchInvoicesPages2(query: string) {
  try {
...
export async function fetchInvoiceById2(id: string) {
  try {
...
export async function fetchCustomers2() {
  try {
